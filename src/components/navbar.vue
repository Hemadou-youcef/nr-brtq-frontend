<template>
  <div>
    <v-app-bar app mobile-break-point="960" color="#7c6e59" flat>
    ...
    <v-navigation-drawer v-model="drawer" :width="(extraSmall && drawer)?'80%':'255px'" app>
      <v-card
        flat
...
export default {
  ...
  computed: {
    metaRoute() {
      ...
      else return "/" + this.$route.fullPath.split("/")[1];
    },
